        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-2">
              <h4 className="font-medium">How to use this query:</h4>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Alert className="mt-4">
              <Info className="h-4 w-4" />
              <AlertDescription>
                <strong>Hybrid Model (Base + Spillover):</strong> Reserve base PTUs for average usage, let burst traffic "spill over" to PAYGO. Best for predictable baselines with occasional bursts (≈2–5×). Set base to your AvgPTU or P99PTU from KQL; overflow is billed at PAYGO.
                <br />
                <strong>Example:</strong> Need 2 PTU avg, 8 PTU peaks → reserve 2–3 PTUs and let the extra 5–6 PTUs use PAYGO.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
          ...
          <>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium mb-2">PTU Conversion Rate (50,000)</h4>
                    ...
                    <h4 className="font-medium mb-2">Base PTUs for Hybrid Model</h4>
                    <p className="text-sm text-gray-600 mb-4">
                    ...
                    <h4 className="font-medium mb-2">Hybrid Strategy Benefits</h4>
                  ...
                  <div>
                    ...
                    <h4 className="font-medium mb-2">Monthly Minutes</h4>
                    <p className="text-sm text-gray-600 mb-4">
                      Default 43,800 minutes assumes continuous 24/7 usage (30.4 days × 24 hours × 60 minutes).
                    </p>
                    
                    <h4 className="font-medium mb-2">Dynamic Pricing Updates</h4>
                    <p className="text-sm text-gray-600">
