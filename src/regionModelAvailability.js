...
export const REGION_MODEL_AVAILABILITY = {
  ...
  'eastus': {
    ...
    available_models: {
      ...
      'gpt-5': { deployments: ['global', 'dataZone', 'regional'], capacity: 'medium' },
      'gpt-5-mini': { deployments: ['global', 'dataZone', 'regional'], capacity: 'high' },
      'gpt-5.1': { deployments: ['global', 'dataZone', 'regional'], capacity: 'medium' },
      'gpt-5.2': { deployments: ['global', 'dataZone', 'regional'], capacity: 'low' },
  ...
  'usgovarizona': {
    ...
    available_models: {
      ...
      'gpt-5.4': { deployments: ['regional'], capacity: 'low' },
      'gpt-5.4-mini': { deployments: ['regional'], capacity: 'low' },
      'gpt-5.5': { deployments: ['regional'], capacity: 'low' },
      'gpt-5.3-codex': { deployments: ['regional'], capacity: 'low' },
      'gpt-5.2-codex': { deployments: ['regional'], capacity: 'low' },
      'gpt-5.1-codex': { deployments: ['regional'], capacity: 'low' },
      'gpt-4.1': { deployments: ['regional'], capacity: 'high' },
      'gpt-4.1-mini': { deployments: ['regional'], capacity: 'high' },
      'gpt-4.1-nano': { deployments: ['regional'], capacity: 'high' },
      'o3': { deployments: ['regional'], capacity: 'medium' },
      'o4-mini': { deployments: ['regional'], capacity: 'medium' },
      'o1': { deployments: ['regional'], capacity: 'medium' },
